...
__global__ void MSD_GPU_calculate_partials_2d(input_type const* __restrict__ d_input, float *d_output_partial_MSD, int *d_output_partial_nElements, int y_steps, size_t nTimesamples, int offset) {
	...
	size_t gpos = blockIdx.z*nTimesamples*gridDim.y*y_steps + blockIdx.y*((size_t) y_steps)*nTimesamples + spos;
	M=0;	S=0;	j=0;
...
template<typename input_type>
__global__ void MSD_GPU_calculate_partials_2d_and_minmax(input_type const* __restrict__ d_input, float *d_output_partial_MSD, int *d_output_partial_nElements, int y_steps, size_t nTimesamples, int offset) {
...
template<typename input_type>
__global__ void MSD_BLN_calculate_partials_2d_and_minmax_with_outlier_rejection(input_type const* __restrict__ d_input, float *d_output_partial_MSD, int *d_output_partial_nElements, float *d_MSD, int y_steps, size_t nTimesamples, int offset, float bln_sigma_constant) {
	__shared__ float s_par_MSD[MSD_PARTIAL_SIZE*MSD_NTHREADS];
	__shared__ int s_par_nElements[MSD_NTHREADS];
...
template<typename input_type>
void call_MSD_GPU_calculate_partials_2d(const dim3 &grid_size, const dim3 &block_size, int shared_memory_bytes, cudaStream_t streams,
			input_type *d_input, float *d_output_partial_MSD, int *d_output_partial_nElements, int y_steps, size_t nTimesamples, int offset){
	MSD_GPU_calculate_partials_2d<<< grid_size, block_size, shared_memory_bytes, streams>>>(d_input, d_output_partial_MSD, d_output_partial_nElements, y_steps, nTimesamples, offset);
}
...
void call_MSD_GPU_calculate_partials_2d_and_minmax(const dim3 &grid_size, const dim3 &block_size, int shared_memory_bytes, cudaStream_t streams,
			input_type *d_input, float *d_output_partial_MSD, int *d_output_partial_nElements, int y_steps, size_t nTimesamples, int offset) {
	MSD_GPU_calculate_partials_2d_and_minmax<<< grid_size, block_size, shared_memory_bytes, streams>>>(d_input, d_output_partial_MSD, d_output_partial_nElements, y_steps, nTimesamples, offset);
}
...
void call_MSD_BLN_calculate_partials_2d_and_minmax_with_outlier_rejection(const dim3 &grid_size, const dim3 &block_size, int shared_memory_bytes, cudaStream_t streams,
	...
	MSD_BLN_calculate_partials_2d_and_minmax_with_outlier_rejection<<< grid_size, block_size, shared_memory_bytes, streams>>>(d_input, d_output_partial_MSD, d_output_partial_nElements, d_MSD, y_steps, nTimesamples, offset, bln_sigma_constant);
}
//---------------------------------------------------------------------------<
